...
# --- Recommended 6-Color Versatile Palette ---
COLOR_PALETTE = {
    "WarmPrimary_Vermilion": hex_to_rgb("#E34234"),       # Warm Red
    "CoolPrimary_Ultramarine": hex_to_rgb("#3F51B5"),     # Cool Blue
    "Yellow_LemonYellow": hex_to_rgb("#FDFD96"),          # Yellow (using Cool/Lemon)
    "DarkNeutral_BurntUmber": hex_to_rgb("#8A4B28"),      # Dark Neutral
    "LightNeutral_TitaniumWhite": hex_to_rgb("#FFFFFF"),  # Light Neutral
    "Accent_PhthaloGreen": hex_to_rgb("#008878"),         # Accent (Alt: Quinacridone Magenta #8E3A59)
}
