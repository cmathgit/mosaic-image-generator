...
COLOR_PALETTE = {
    ...
    "CoolRed_AlizarinCrimson": hex_to_rgb("#B22222"),
    "DeepRed_OxideRed": hex_to_rgb("#8B0000"),
    "MutedRed_IndianRed": hex_to_rgb("#CD5C5C"),
    # Oranges
    "VibrantOrange_CadmiumOrange": hex_to_rgb("#F97306"),
    "EarthyOrange_BurntSienna": hex_to_rgb("#E97451"),
    # Yellows
    "CoolYellow_LemonYellow": hex_to_rgb("#FFF44F"),
    "WarmYellow_CadmiumYellowDeep": hex_to_rgb("#F6A623"),
    "MutedYellow_YellowOchre": hex_to_rgb("#C5A059"),
    # Greens
    "CoolGreen_PhthaloGreen": hex_to_rgb("#008878"),
    "WarmGreen_SapGreen": hex_to_rgb("#507D2A"),
    "MutedGreen_Olive": hex_to_rgb("#808000"),
    "LushGreen_Emerald": hex_to_rgb("#50C878"),
    # Blues
    "WarmBlue_Ultramarine": hex_to_rgb("#3F51B5"),
    "CoolBlue_Cerulean": hex_to_rgb("#00A6D6"),
    "MutedBlue_Slate": hex_to_rgb("#6A7BA2"),
    "AccentBlue_ElectricBlue": hex_to_rgb("#0077FF"),
    # Purples
    "WarmPurple_DioxazineViolet": hex_to_rgb("#6A0DAD"),
    "CoolPurple_Periwinkle": hex_to_rgb("#CCCCFF"),
    "MutedPurple_Mauve": hex_to_rgb("#915F6D"),
    # Neutrals
    "White_TitaniumWhite": hex_to_rgb("#FFFFFF"),
    "Black_IvoryBlack": hex_to_rgb("#1C1C1C"),
    "WarmGray_PaynesGray": hex_to_rgb("#404958"),
    "CoolGray_SilverGray": hex_to_rgb("#C0C0C0"),
}
